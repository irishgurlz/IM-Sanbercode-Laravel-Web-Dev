<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light custom-border-radius bg-white ml-4 my-3" id="sidenav-main">
        ...
        <ul class="navbar-nav ">
          <li class="nav-item">
            <a class="nav-link" href="/film">
              <i class="ni ni-tv-2 text-primary"></i> Film
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href = "/genre">
              <i class="ni ni-planet text-blue"></i> Genre 
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="/cast">
              <i class="ni ni-single-02 text-yellow"></i> Cast
            </a>
          </li>
          <li class="nav-item">
